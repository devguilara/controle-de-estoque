        ...
        <div class="col-lg-3 col-md-6">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-xs-3">
                        <img class="img-fluid" style="width:65px" src="./assets/img/colaborativo.png" alt="" srcset="">
                        </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="panel panel-green">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-xs-3">
                            <img class="img-fluid" style="width:65px" src="./assets/img/armazem.png" alt="" srcset="">
                        </div>
                        <div class="col-xs-9 text-right">
